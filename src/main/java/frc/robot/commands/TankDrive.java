...
public class TankDrive extends CommandBase {
    ...
    public void execute() {
        ...
        SmartDashboard.putString("Left Bumper", "false");
        SmartDashboard.putString("Right Bumper", "false");

        if (joystick.getLeftBumper()){            
            SmartDashboard.putString("Left Bumper", "true");
        ...
        if (joystick.getRightBumper()){
            SmartDashboard.putString("Right Bumper", "true");
